    ...
    >
      ...
      <el-table-column label="状态" align="center" width="80">
        <template #default="scope">
          <el-tag v-if="scope.row.isEnable" type="success" round>正常</el-tag>
      ...
      >
        <template #default="scope">
          <el-dropdown @command="(cmd) => handleCommand(cmd, scope.row)">
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item command="edit" icon="Edit" v-hasPermi="['adm:seal:edit']">修改</el-dropdown-item>
                <el-dropdown-item command="delete" icon="Delete" v-hasPermi="['adm:seal:delete']">删除</el-dropdown-item>
              </el-dropdown-menu>
            </template>
          </el-dropdown>
        </template>
